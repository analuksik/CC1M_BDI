...
ALTER TABLE PAGAMENTOS CHANGE COLUMN PG_FORMA_PAGAMENTO PG_formaPagamento VARCHAR(20);
ALTER TABLE PAGAMENTOS MODIFY COLUMN PG_formaPagamento VARCHAR(30);
ALTER TABLE PAGAMENTOS DROP COLUMN PG_formaPagamento;
...
ALTER TABLE PLANOS_TREINAMENTO ADD COLUMN STATUS ENUM('ATIVO', 'INATIVO');
ALTER TABLE PLANOS_TREINAMENTO CHANGE COLUMN STATUS PLANO_STATUS ENUM('ATIVO', 'INATIVO');
...
ALTER TABLE AULAS_ALUNOS ADD COLUMN aulaDATA DATE;
ALTER TABLE AULAS_ALUNOS CHANGE COLUMN aulaDATA AULA_ALUNO_DATA DATE;
